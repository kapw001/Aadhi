package com.app.aadhi.dashboard.srathampinda;
...
public class SrathamPindaMenuActivity extends RootActivity implements View.OnClickListener, DatePickerDialogFragment.OnDateSetListener, RootActivity.MailSendResponse {
    ...
    private void setTextForAllUiViews() {
        mTitle.setText(getString(R.string.sratham_pinda_title));
        mDate.setVisibility(View.GONE);
        mTime.setVisibility(View.GONE);
        mContentImage.setImageResource(R.drawable.ic_sratham_pinda_img1);
        mContentImage.setScaleType(ImageView.ScaleType.CENTER_CROP);
        mContentDescription.setText(getString(R.string.sratham_pinda_description));
        mRow1Title.setText(getString(R.string.gotharam_thithi));
        mRow2Title.setText(getString(R.string.date));
        mRow3Title.setText(getString(R.string.whatsapp_no));
        mRow4Title.setText(getString(R.string.mobile_number));
        mRow6Title.setText(getString(R.string.type_of_pooja));
        mRow7Title.setText(getString(R.string.description));


        mDateET.setInputType(EditorInfo.TYPE_CLASS_NUMBER);
        com.app.aadhi.utils.TextUtils.SetMaxLength10(mDateET);
        ...
        mGothramThithiET.setFocusable(false);
        mGothramThithiET.setOnClickListener(this);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.sradham_thithi_options, R.layout.spinner_layout_simple_item);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.submit:
                ...
                if (isValidInput) {
                    Message vastuDetailsEmail = EmailUtils.composeSrathamThithiEmail(mNameET.getText().toString(),
                            mGothramThithiET.getText().toString(),
    ...
    private boolean validateFormInputFields() {
        return !(TextUtils.isEmpty(mNameET.getText()) ||
                TextUtils.isEmpty(mGothramThithiET.getText()) ||
...
//                TextUtils.isEmpty(mMobileNoET.getText()) ||
    ...
    public void onDateSet(Date date) {
        ...
        mGothramThithiET.setText(dateString);
    }

    private void clearAllInputFields() {
        mNameET.setText("");
        mNameET.requestFocus();
        mGothramThithiET.setText("");
        mDateET.setText("");
