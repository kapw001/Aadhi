...
public class PoojaForChildrenMenuActivity extends RootActivity implements View.OnClickListener, DatePickerDialogFragment.OnDateSetListener, RootActivity.MailSendResponse {
    ...
    private void setTextForAllUiViews() {
        mTitle.setText(getString(R.string.pooja_children_title));
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.pooja_children_options, R.layout.spinner_layout_simple_item);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.submit:
                ...
                if (isValidInput) {
                    Message vastuDetailsEmail = EmailUtils.composePoojaForChildrenEmail(mNameET.getText().toString(),
