...
public class VideoMessagesListActivity_ViewBinding implements Unbinder {
  private VideoMessagesListActivity target;

  @UiThread
  public VideoMessagesListActivity_ViewBinding(VideoMessagesListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public VideoMessagesListActivity_ViewBinding(VideoMessagesListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    VideoMessagesListActivity target = this.target;
