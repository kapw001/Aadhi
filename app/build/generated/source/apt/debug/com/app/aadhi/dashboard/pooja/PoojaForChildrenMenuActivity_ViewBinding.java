...
public class PoojaForChildrenMenuActivity_ViewBinding implements Unbinder {
  private PoojaForChildrenMenuActivity target;

  @UiThread
  public PoojaForChildrenMenuActivity_ViewBinding(PoojaForChildrenMenuActivity target) {
  ...
  @CallSuper
  public void unbind() {
    PoojaForChildrenMenuActivity target = this.target;
