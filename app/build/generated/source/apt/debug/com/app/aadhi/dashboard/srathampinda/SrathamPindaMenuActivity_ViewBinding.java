...
public class SrathamPindaMenuActivity_ViewBinding implements Unbinder {
  private SrathamPindaMenuActivity target;

  @UiThread
  public SrathamPindaMenuActivity_ViewBinding(SrathamPindaMenuActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SrathamPindaMenuActivity_ViewBinding(SrathamPindaMenuActivity target, View source) {
    this.target = target;
    ...
    target.mGothramThithiET = Utils.findRequiredViewAsType(source, R.id.row2_description, "field 'mGothramThithiET'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    SrathamPindaMenuActivity target = this.target;
